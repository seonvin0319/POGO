...
if __name__ == "__main__":
    ...
    print("======================================")
    print(f"[SETUP] 2-step refine, env={args.env}, seed={args.seed}")
    ...
    for stage in range(num_steps):
        ...
        print("======== Multi-step Evaluation (2-step refine) ========")
        final_scores = []
    ...
    # Final evaluation
    print("======== Final Evaluation (2-step refine) ========")
    final_scores = []
    for r in range(args.final_eval_runs):
        score = eval_policy(
            agent, args.env, args.seed, mean, std,
